import {TokenName, TokenType} from "./types";
  ...
  nextToken() {
    while (!this.isEOF) {
      switch (this.c) {
        ...
        case "{":
          this.consume();
          return new Token(1, "{", this.i, this.i);
        case ":":
          this.consume();
          return new Token(2, ":", this.i, this.i);
        case ",":
          this.consume();
          return new Token(3, ",", this.i, this.i);
        case "}":
          this.consume();
          return new Token(4, "}", this.i, this.i);
        case "[":
          this.consume();
          return new Token(5, "[", this.i, this.i);
        case "]":
          this.consume();
          return new Token(6, "]", this.i, this.i);
        default:
          if (this.isKeyword("true")) return this.keywordToken("true");
            ...
            throw new Error(
              `Unexpected character ${this.c} in JSON at position ${this.i}`
            );
      }
    }
